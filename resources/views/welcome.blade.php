  ...
  <body>
    ...
    <div class="contact-form">
        <form method="post" onsubmit="return calculateBonds()">
            <div class="container">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName" placeholder="00.00" required="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <span>Coupon Rate (%)</span>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="00.00" required="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <span>Year (yr)</span>
                        <input type="text" class="form-control" id="exampleInputPhone" placeholder="1" required="">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="col-lg-12">             
                    <textarea class="form-control" rows="5" placeholder="results here.."></textarea>         
                    <div class="form-group">
